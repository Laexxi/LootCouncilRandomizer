...
function addon:GetGuildMembersByMinRank()
    local membersByRank = {}
    if IsInGuild() then
        local minRankIndex = (self.db.profile.selectedRankIndex or 1) - 1 -- Adjust for zero-based index from WoW API
            ...
            settings = {
                ...
                args = {
                    ...
                    guildRank = {
                        ...
                        order = nextOrder(),
                        get = function(info)
                            return self.db.profile.selectedRankIndex or 1
                        end,
                        set = function(info, value)
                            self.db.profile.selectedRankIndex = value -- Index adjustment happens in retrieval
